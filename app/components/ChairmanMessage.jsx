...
export default function ChairmanMessage({ data }) {
  // Fallback defaults if data is missing
  const content = data || {
    quote: `"Human potential is the most powerful force behind progress. Our mission is not just business growth—it is to create jobs, empower youth, and champion women's leadership."`,
    name: "Sabina Akter",
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[15vw] font-bold text-slate-900/3 select-none pointer-events-none whitespace-nowrap">
        BETOPIA
      </div>
    </section>
  );
